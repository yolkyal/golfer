...
class TestHole(unittest.TestCase):
	def setUp(self):
		...
		self.hole = hole.Hole(self.ball, self.hole_pos, [self.wall])
	...
	def testUpdateWithDoubleWallCollision(self, mock_get_dist):
		...
		self.hole = hole.Hole(self.ball, self.hole_pos, [wall1, wall2])
	...
	def testIsComplete(self):
		...
		self.assertTrue(self.hole.is_complete())